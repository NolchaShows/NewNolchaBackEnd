  ...
  return {
    ...
    graphql: {
      ...
      config: {
        endpoint: '/graphql',
        shadowCRUD: true,
        // Keep the landing page off in production by default.
        // You can override this with GRAPHQL_LANDING_PAGE=true if desired.
        landingPage: env.bool('GRAPHQL_LANDING_PAGE', !isProduction),
